    ...
    return {
      ...
      link: function (scope, element) {
        ...
        scope.render = function (alldatas) {
          ...
          svg.append('path')
              .datum(data)
              .attr('class', 'carbon-area area')
              .attr('fill', 'url(' + location.href + '#carbon-grad)')
              .attr('d', area);
          ...
          d3.select('.carbon-area').on('mousemove', function (d, i) {
            ...
            d3.select(this)
              ...
              tooltip.html('<div class="tooltip-arrow"></div><div class="tooltip-inner"><p>' + yValue + ' ppm<br>' + moment(xValue).format('LLLL') + '</p></div>').style('visibility', 'visible');
          });
